...
#define MESON_SDHC_CLKC						0x10
	/* It's very bogus that datasheet doesn't match the hardware at all... */
	...
	#define MESON_SDHC_CLKC_CLK_IN_SEL			GENMASK(17, 16)
		/* OSC is 24MHz */
		#define MESON_SDHC_CLK_OSC			0
		#define MESON_SDHC_CLK_FCLK_DIV4		1
		#define MESON_SDHC_CLK_FCLK_DIV3		2
		#define MESON_SDHC_CLK_FCLK_DIV5		3
