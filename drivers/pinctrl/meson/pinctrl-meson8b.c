...
static const unsigned int sdxc_d47_a_pins[]	= { PIN(GPIOX_4, EE_OFF), PIN(GPIOX_5, EE_OFF),
						    PIN(GPIOX_6, EE_OFF), PIN(GPIOX_7, EE_OFF) };
static const unsigned int sdxc_d13_0_a_pins[]	= { PIN(GPIOX_5, EE_OFF), PIN(GPIOX_6, EE_OFF),
						    PIN(GPIOX_7, EE_OFF) };
...
static const unsigned int sdxc_d13_1_a_pins[]	= { PIN(GPIOX_1, EE_OFF), PIN(GPIOX_2, EE_OFF),
						    PIN(GPIOX_3, EE_OFF) };
...
static const unsigned int tsin_d17_a_pins[] = {
	PIN(GPIOY_6, EE_OFF), PIN(GPIOY_7, EE_OFF), PIN(GPIOY_10, EE_OFF), PIN(GPIOY_11, EE_OFF),
...
static const unsigned int eth_rxd3_h_pins[]	= { PIN(GPIOH_5, EE_OFF) };
static const unsigned int eth_rxd2_h_pins[]	= { PIN(GPIOH_6, EE_OFF) };
...
static const unsigned int nand_io_pins[] = {
	PIN(BOOT_0, EE_OFF), PIN(BOOT_1, EE_OFF), PIN(BOOT_2, EE_OFF), PIN(BOOT_3, EE_OFF),
	PIN(BOOT_4, EE_OFF), PIN(BOOT_5, EE_OFF), PIN(BOOT_6, EE_OFF), PIN(BOOT_7, EE_OFF)
};
...
static const unsigned int nand_dqs_15_pins[]	= { PIN(BOOT_15, EE_OFF) };
static const unsigned int nand_dqs_18_pins[]	= { PIN(BOOT_18, EE_OFF) };

static const unsigned int sdxc_d0_c_pins[]	= { PIN(BOOT_0, EE_OFF)};
static const unsigned int sdxc_d13_c_pins[]	= { PIN(BOOT_1, EE_OFF), PIN(BOOT_2, EE_OFF),
						    PIN(BOOT_3, EE_OFF) };
static const unsigned int sdxc_d47_c_pins[]	= { PIN(BOOT_4, EE_OFF), PIN(BOOT_5, EE_OFF),
...
static const unsigned int sdxc_d13_b_pins[]	= { PIN(CARD_0, EE_OFF),  PIN(CARD_4, EE_OFF),
						    PIN(CARD_5, EE_OFF) };
...
static const unsigned int eth_rxd3_pins[]	= { PIN(DIF_2_P, EE_OFF) };
static const unsigned int eth_rxd2_pins[]	= { PIN(DIF_2_N, EE_OFF) };
...
static struct meson_bank meson8b_cbus_banks[] = {
	...
	BANK("X0..11",	 PIN(GPIOX_0, EE_OFF),	PIN(GPIOX_11, EE_OFF),   4,  0,   4,  0,   0,  0,   1,  0,   2,  0),
	BANK("X16..21",	 PIN(GPIOX_16, EE_OFF),	PIN(GPIOX_21, EE_OFF),  4, 16,   4, 16,   0, 16,   1, 16,   2, 16),
	BANK("Y0..1",	 PIN(GPIOY_0, EE_OFF),	PIN(GPIOY_1, EE_OFF),    3,  0,   3,  0,   3,  0,   4,  0,   5,  0),
	BANK("Y3",	 PIN(GPIOY_3, EE_OFF),	PIN(GPIOY_3, EE_OFF),    3,  3,   3,  3,   3,  3,   4,  3,   5,  3),
	BANK("Y6..14",	 PIN(GPIOY_6, EE_OFF),	PIN(GPIOY_14, EE_OFF),   3,  6,   3,  6,   3,  6,   4,  6,   5,  6),
	BANK("DV9",	 PIN(GPIODV_9, EE_OFF),	PIN(GPIODV_9, EE_OFF),   0,  9,   0,  9,   7,  9,   8,  9,   9,  9),
	BANK("DV24..29", PIN(GPIODV_24, EE_OFF),	PIN(GPIODV_29, EE_OFF),  0, 24,   0, 24,   7, 24,   8, 24,   9, 24),
	BANK("H",	 PIN(GPIOH_0, EE_OFF),	PIN(GPIOH_9, EE_OFF),    1, 16,   1, 16,   9, 19,  10, 19,  11, 19),
	BANK("CARD",	 PIN(CARD_0, EE_OFF),	PIN(CARD_6, EE_OFF),     2, 20,   2, 20,   0, 22,   1, 22,   2, 22),
	BANK("BOOT",	 PIN(BOOT_0, EE_OFF),	PIN(BOOT_18, EE_OFF),    2,  0,   2,  0,   9,  0,  10,  0,  11,  0),
	 ...
	 */
	BANK("DIF",	 PIN(DIF_0_P, EE_OFF),	PIN(DIF_4_N, EE_OFF),    5,  8,   5,  8,  12, 12,  13, 12,  14, 12),
};

static struct meson_bank meson8b_aobus_banks[] = {
	/*   name    first     lastc        irq    pullen  pull    dir     out     in  */
	BANK("AO",   PIN(GPIOAO_0, 0), PIN(GPIO_TEST_N, 0), 0,  16, 0, 0,  0,  0,  0, 16,  1,  0),
};
...
static const struct udevice_id meson8b_pinctrl_match[] = {
	{
		.compatible = "amlogic,meson8b-cbus-pinctrl",
		.data = (ulong)&meson8b_cbus_pinctrl_data,
	},
	{
		.compatible = "amlogic,meson8b-aobus-pinctrl",
		.data = (ulong)&meson8b_aobus_pinctrl_data,
	},
	{ /* sentinel */ }
};

U_BOOT_DRIVER(meson8b_pinctrl) = {
	.name		= "meson8b-pinctrl",
	.id		= UCLASS_PINCTRL,
	.of_match	= of_match_ptr(meson8b_pinctrl_match),
