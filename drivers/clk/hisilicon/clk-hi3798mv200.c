...
#define HI3798MV200_FIXED_300M			80
#define HI3798MV200_FIXED_337P5M		81
#define HI3798MV200_MMC_MUX			82
#define HI3798MV200_GMAC_MUX			83
#define HI3798MV200_EXTPHY_MUX			84
#define HI3798MV200_FEMAC_MUX			85
#define HI3798MV200_SDIO0_MUX			86
#define HI3798MV200_COMBPHY0_MUX		87
#define HI3798MV200_SDIO1_MUX			88
#define HI3798MV200_UART0_MUX			89
...
static const struct hisi_fixed_rate_clock hi3798mv200_fixed_rate_clks[] = {
	...
	{ HI3798MV200_FIXED_166P5M, "166p5m", 166500000, },
	{ HI3798MV200_FIXED_200M, "200m", 200000000, },
	{ HI3798MV200_FIXED_300M, "300m", 300000000, },
	{ HI3798MV200_FIXED_337P5M, "337p5m", 337500000, },
};

static const char *const mmc_mux_p[] = {
		"100m", "50m", "25m", "200m", "300m", "337p5m", "150m" };
...
static const char *const gmac_mux_p[] = {
		"75m", "125m" };
static u32 gmac_mux_table[] = {0, 1};

static const char *const extphy_mux_p[] = {
		"25m", "50m" };
static u32 extphy_mux_table[] = {0, 1};

static const char *const femac_mux_p[] = {
		"54m", "27m" };
static u32 femac_mux_table[] = {0, 1};
...
static struct hisi_mux_clock hi3798mv200_mux_clks[] = {
	...
	{ HI3798MV200_GMAC_MUX, "gmac_mux", gmac_mux_p,
		ARRAY_SIZE(gmac_mux_p), CLK_SET_RATE_PARENT,
		0xcc, 7, 1, 0, gmac_mux_table, },
	{ HI3798MV200_EXTPHY_MUX, "extphy_mux", extphy_mux_p,
		ARRAY_SIZE(extphy_mux_p), CLK_SET_RATE_PARENT,
		0xcc, 6, 1, 0, extphy_mux_table, },
	{ HI3798MV200_FEMAC_MUX, "femac_mux", femac_mux_p,
		ARRAY_SIZE(femac_mux_p), CLK_SET_RATE_PARENT,
		0xd0, 2, 1, 0, femac_mux_table, },
};
...
static struct hisi_mux_clock hi3798mv200_sysctrl_mux_clks[] = {
	{ HI3798MV200_UART0_MUX, "uart0_mux", uart0_mux_p,
		ARRAY_SIZE(uart0_mux_p), CLK_SET_RATE_PARENT,
		0x48, 29, 1, 0, uart0_mux_table, },
};
